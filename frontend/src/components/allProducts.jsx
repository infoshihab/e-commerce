...
const AllProduct = () => {
  const { user, addToCart, openCart } = useAppContext();
  ...
  // Replace your old handleQuickAdd with this:
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
      <h2 className="text-4xl text-center mb-10 text-gray-900">ALL PRODUCTS</h2>
          ...
          >
            ...
            <div className="px-4 pb-4 pt-2 flex justify-center">
              <button
                ...
                className="inline-block rounded-lg bg-[#fc8934] hover:bg-orange-500 text-white px-8 py-3 text-sm md:text-base focus:outline-none"
              >
                Quick Add
              </button>
            </div>
